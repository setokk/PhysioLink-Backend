...
CREATE  TABLE physiolink.patient ( 
	...
	email                VARCHAR(70) CHARACTER SET utf8 NOT NULL     ,
	phone_number         VARCHAR(25) CHARACTER SET utf8 NOT NULL     ,
	amka                 VARCHAR(10) CHARACTER SET utf8 NOT NULL     ,
	name                 VARCHAR(50) CHARACTER SET utf8 NOT NULL     ,
	surname              VARCHAR(50) CHARACTER SET utf8 NOT NULL     ,
...
INSERT INTO physiolink.doctor (id, name, surname, email, phone_number, afm, city, address, postal_code, physio_name) VALUES (2, "Μιχαήλ", "Μπρο", "michael@physiolink.gr", "6934236578", "11594834", "Θεσσαλονίκη", "Εγνατίας 24", "58234", "Απόλλων");
INSERT INTO physiolink.patient (id, name, surname, email, phone_number, city, address, postal_code, amka, doctor_id) VALUES (3, "Γιώργος", "Μπροο", "giwrgos@physiolink.gr", "6905394567", "Κιλκίς", "Εγνατίας 10", "55344", "160501356", 2);